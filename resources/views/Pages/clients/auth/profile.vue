                    ...
                    <div class="col-md-8">
                        <div class="card-body p-4">
                            ...
                            <div class="row pt-2">
                                <div class="col-sm-6 mb-3">
                                    <h6>Họ tên</h6>
                                    <a-input placeholder="Họ tên" v-model:value="name" class="text-muted"></a-input>
                                    <small v-if="errors.name" class="text-danger">{{ errors.name[0] }}</small>
                                </div>
                                <div class="col-sm-6 mb-3">
                                    <h6>Email</h6>
                                    <a-input placeholder="Họ tên" v-model:value="email" class="text-muted"></a-input>
                            ...
                            <div v-if="changePassword === true" class="row pt-1">
                                <div class="col-sm-6 mb-3">
                                    ...
                                    <a-input-password allow-clear placeholder="Mật khẩu mới" v-model:value="password"
                                ...
                                <div class="col-sm-6 mb-3">
                                    ...
                                    <a-input-password allow-clear placeholder="Xác nhận mật khẩu"
                                        v-model:value="password_confirmation" class="text-muted"></a-input-password>
                                </div>
                            </div>
                            <div class="row mt-5">
